      ...
      <div className="section-container">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Your Privacy, No Compromise</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-gray-300">On premise deployment for Enterprises</p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-6 h-6 bg-neon/20 rounded-full flex items-center justify-center mr-3 mt-1">
                  <span className="text-neon font-bold text-sm">✓</span>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-72 h-72">
              ...
              <div className="absolute -right-4 top-1/4 w-48 h-12 glass-card border-neon/30 flex items-center justify-center text-neon text-sm animate-float">On premise</div>
              
              <div className="absolute -left-4 bottom-1/4 w-48 h-12 glass-card border-neon/30 flex items-center justify-center text-neon text-sm animate-float" style={{
              animationDelay: "1s"
            }}>
                GDPR Compliant
              </div>
              
              <div className="absolute top-0 left-1/4 w-48 h-12 glass-card border-electric/30 flex items-center justify-center text-electric text-sm animate-float" style={{
              animationDelay: "2s"
            }}>
                Opt-Out Controls
              </div>

...
const FeaturesSection = () => {
  return <section className="bg-obsidian py-20">
      <div className="section-container">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">Why It's Not Just Another Agent</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <FeatureCard icon={<UserCog size={32} />} title="Your Digital Twin" description="VariasAI learn from your habits to book, negotiate, and optimize your workflows, becoming more autonomous over time." />

...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center bg-hero-gradient overflow-hidden">
      ...
      <div className="absolute -left-20 top-2/4 w-96 h-96 bg-neon/10 rounded-full filter blur-3xl animate-float" style={{
      animationDelay: "2s"
    }}></div>
      
      <div className="section-container relative z-10 flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-6 text-white">
          Your Browser, Now <span className="text-neon">Supercharged</span>
        </h1>
        
        <p className="text-lg md:text-xl max-w-3xl mb-10 text-gray-300">VariasAI is your intelligent copilot, it analyzes activity across tabs to anticipate needs and acts proactively - eliminating the need for manual prompts.</p>
        ...
        <div className="w-72 h-72 mb-12 relative">
          ...
          <div className="absolute inset-4 bg-graphite rounded-full overflow-hidden flex items-center justify-center">
            <div className="w-4/5 h-4/5 border border-neon/30 rounded-xl bg-obsidian/80 flex flex-col shadow-neon animate-float" style={{
